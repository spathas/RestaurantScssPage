...
function handlePosition(photo) {
  ...
  photo.style.transform = `translateY(${innerHeight / 2 - height / 2 - top}px) translateX(${innerWidth / 2 - width / 2 - left}px) scale(1.7)`;
}
...
document.addEventListener("click", hide); // for demo
